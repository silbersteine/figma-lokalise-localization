...
- [ ] **Behavior change** to a flow (setup / sync / download / check-stale / update-source)
- [ ] **Reference/contract** change (storage fields, naming, hash policy, mapping)
- [ ] **Docs / clarity only** (no change to what an agent does)
- [ ] Scaffolding (README, CI, install scripts) — no skill change
